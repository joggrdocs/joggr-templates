...
| Joggr    | All product requirements **MUST** be saved to `Product/Requirements`       | All RFCs **MUST** be saved to `RFCs`       | All Architecture Docs **MUST** be saved to `Architecture` or `Technology/<component>/Libraries`             | All guides **MUST** be saved to `Technology/<component>/Guides`           | All library docs **MUST** be saved to `Technology/<component>/Libraries` | All API Docs **MUST** be saved to ENTER_URL    |
